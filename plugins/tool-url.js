...
cmd({
  ...
  try {
    ...
    else if (mimeType.includes('audio/ogg') || mimeType.includes('opus')) extension = '.opus';
    ...
    const apiResponse = await axios.post('https://adeel-api-6ede3f5901b3.herokuapp.com/api/imgtourl', form, {
      headers: {
        ...form.getHeaders(),
